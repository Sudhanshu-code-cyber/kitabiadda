<div id="animation-carousel" class="relative w-full" data-carousel="static">
    <div class="px-[5%]">
        <div class="flex   border-b   border-gray-500 item-center  flex-1 justify-between items-center py-4 px-6x">
            <h1 class="font-bold text-2xl text-[#] ">New Releases</h1>
            <a href="#"
    ...
    <!-- Carousel wrapper -->
    <div
        class="relative   h-[100px] gap-10  flex justify-center items-center ml-20 overflow-hidden rounded-lg md:h-115">
        <!-- Item 1 -->
