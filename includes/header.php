...
<div class="flex fixed w-full z-50 top-0 xl:gap-10 lg:gap-[5rem] md:gap-7  items-center bg-[#3D8D7A] px-[5%] py-3">
    ...
    <div
        class="hidden md:flex xl:flex xl:justify-between lg:justify-between lg:w-[60rem] xl:w-[62rem] items-center space-x-4 lg:space-x-6">
        <!-- Search Bar -->
        <form action="filter.php" method="get" class="flex xl:w-[35rem] rounded">
            <input type="search" name="search_book" placeholder="Search by ISBN or name..."
                class="p-2 bg-white rounded-l-md  xl:w-[32rem] lg:w-[26rem] text-black border-0 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0">
