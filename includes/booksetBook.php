...
// Fetch old books
$booksQuery = $connect->query("SELECT * FROM books WHERE book_category='+ Add Book Sets' ORDER BY id DESC");
...
<section class="mt-10">
    <div class="w-full mx-auto px-[2%]">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="booksets2.php?bookType2=+ Add Book Sets" class="text-orange-500 font-semibold hover:underline">View All</a>
                    </div>
