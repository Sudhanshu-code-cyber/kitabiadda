    ...
    <div class="w-full px-[2%] mx-auto">
        ...
        <div class="relative">
            ...
            <button id="scrollLeft3"
                class="hidden sm:flex absolute z-10 left-0 top-1/2 -translate-y-1/2 bg-white border rounded-full shadow p-2 hover:bg-gray-100">
                &#8592;
            </button>

            <div id="bookScroll3" class="flex space-x-4 overflow-x-auto scroll-smooth  sm:px-10 pb-4">
                    ...
                    <div
                        ...
                        <a href="view.php?book_id=<?= $book['id']; ?>" class="block">
                            ...
                            <div class="mt-2 sm:mt-3 text-center">
                                ...
                                <p class="text-red-400 font-semibold text-[10px] sm:text-xs mt-1">
                                    E-BOOK:
                                    <?= $book['e_book_avl'] == "Yes" ? '₹' . $book['e_book_price'] : "Not Available"; ?>
                                </p>
                            </div>
                        </a>
                        ...
                        <a href="cart.php?add_book=<?= $book['id']; ?>" class="block">
                            <div class="mt-3 sm:mt-4 border-t pt-2 sm:pt-3 flex justify-between items-center">
                                <button class="text-[#27445D] text-[10px] sm:text-xs font-semibold hover:underline">Add to
                                    cart</button>
            ...
            <button id="scrollRight3"
                class="hidden sm:flex absolute z-10 right-0 top-1/2 -translate-y-1/2 bg-white border rounded-full shadow p-2 hover:bg-gray-100">
                &#8594;
            </button>
        </div>
    </div>
