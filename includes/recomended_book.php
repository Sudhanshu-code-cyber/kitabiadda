            ...
            <a href="#" class="text-orange-500 font-semibold hover:underline">View All</a>
                ...
                <div class="relative">
                    ...
                    <div id="bookScroll" class="flex space-x-4 overflow-x-auto scroll-smooth px-10 pb-4">
                        ...
                        <?php  $book_category = $book['book_category'];
                ...
                while ($book = $booksQuery->fetch_assoc()):
                            ...
                            <div
                                ...
                                <form method="POST" action="view.php?book_id=<?= $book_id ?>"
                                ...
                                <a href="cart.php?add_book=<?= $book['id']; ?>" class="block">
                                    <div class="mt-3 sm:mt-4 border-t pt-2 sm:pt-3 flex justify-between items-center">
                                        <button
                                            class="text-[#27445D] text-[10px] sm:text-xs font-semibold hover:underline">Add
                                            to cart</button>
