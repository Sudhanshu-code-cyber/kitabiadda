<div id="my_selling" class="content-section hidden">
    ...
    if ($calling_myItem->num_rows > 0):
            ...
            <div class="flex flex-col gap-4 mt-3 px-2 md:px-0">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between border border-gray-200 p-3 rounded-lg shadow-sm bg-gray-50 gap-3 sm:gap-0">
                    <div class="flex items-center flex-1 min-w-0">
                        <img src="assets/images/<?= $myItem['img1']; ?>" alt="item_image" class="h-16 w-16 sm:h-18 sm:w-18 rounded shadow-sm object-cover">
                    ...
                    <div class="flex flex-col gap-1 items-start sm:items-center w-full sm:w-auto text-xs sm:text-sm">
                        <p class="font-semibold">Book Sold on --DATE--</p>
        ...
        <div class="flex flex-col gap-2 justify-center items-center mt-[10%] px-4 text-center">
            ...
            <a href="sell/sell.php" class="bg-[#3D8D7A] rounded px-3 py-2 text-white font-semibold text-sm sm:text-base hover:bg-[#2a7d6a] transition-colors">Start Selling</a>
        </div>
    <?php endif; ?>
</div>