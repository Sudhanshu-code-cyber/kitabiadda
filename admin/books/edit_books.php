                    ...
                    <div class="container mt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <img id="preview2" src="../../assets/images/<?= $books_row['img2'] ?>" alt="Image 2 Preview" class="img-fluid mt-2"
                                    style="">
                            </div>
                            <div class="col-md-3">
                                ...
                                <img id="preview3" src="../../assets/images/<?= $books_row['img3'] ?>" alt="Image 3 Preview" class="img-fluid mt-2"
                                    style="">
                            </div>
                            <div class="col-md-3">
                                ...
                                <img id="preview4" src="../../assets/images/<?= $books_row['img4'] ?>" alt="Image 4 Preview" class="img-fluid mt-2"
                                    style="">
                            </div>
                        </div>
